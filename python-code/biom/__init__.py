...
sparse_backends = ['SparseDict', 'SparseMat', 'CSMat', 'ScipySparseMat']
...
def get_sparse_backend():
    ...
    if backend == 'SparseMat':
        ...
        try:
            ...
            valid_backend = False
            stderr.write("Cannot load SparseDict, using CSMat\n")
    elif backend == 'ScipySparseMat':
