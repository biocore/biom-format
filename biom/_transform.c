 ...
 *         data[start:end] = function(data[start:end], id_, md)             # <<<<<<<<<<<<<<
 */
    __pyx_t_7 = __Pyx_PyObject_GetSlice(((PyObject *)__pyx_v_data), __pyx_v_start, __pyx_v_end, NULL, NULL, NULL, 1, 1, 1); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    ...
    __pyx_t_17 = PyTuple_New(3+__pyx_t_16); if (unlikely(!__pyx_t_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    PyTuple_SET_ITEM(__pyx_t_17, 1+__pyx_t_16, __pyx_v_id_);
    __Pyx_GIVEREF(__pyx_v_id_);
    __Pyx_INCREF(__pyx_v_md);
    PyTuple_SET_ITEM(__pyx_t_17, 2+__pyx_t_16, __pyx_v_md);
    __Pyx_GIVEREF(__pyx_v_md);
    __pyx_t_7 = 0;
    __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_14, __pyx_t_17, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
