...
* Massive performance boost to `Table.collapse` with the default collapse function. The difference was 10s of milliseconds vs. minutes (before killing the process out of boredom). See [issue #761](https://github.com/biocore/biom-format/issues/761).
